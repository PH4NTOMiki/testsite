hexo.extend.filter.register('after_generate', function(){
	var fs = require('fs'), path = require('path'), sizeOf = require('image-size'), imageThumbnail = require('image-thumbnail');
	...
	//counter=0;
	var arr=walkSync(path.join(__dirname,'..','public','images'));
