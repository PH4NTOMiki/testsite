(function($){
  ...
  <% } %>
  <% if (c.ajaxloader){ %>
    if(history.pushState){cache={},prefetched=[];var $main=$("#main"),$container=$("#container"),tempCache={html:$main.html(),title:document.title,url:location.href};function renderHTML(e,t){$container.removeClass("mobile-nav-on"),t||history.pushState(e,e.title,e.url),document.title=e.title,$main.html(e.html),t||scrollTo(0,0)}function ajaxLoad(e,t){t&&cache[e]&&renderHTML(cache[e]),cache[e]||$.get(e,function(o){o=String(o);var r=document.createElement("textarea");r.innerHTML=o.replace(/.*?<title>(.*?)<\/title>.*/i,"$1");var a=r.value,n=o.replace(/.*?<section id="main">(.*?)<\/section>.*/i,"$1");cache[e]={html:n,url:e,title:a},t&&renderHTML(cache[e])},"text")}cache[tempCache.url]=tempCache,history.replaceState(tempCache,tempCache.title,tempCache.url),$(document).on("click","a",function(e){console.log("triggered second event listener: ",e);var t=e.target;return t.href==location.href?(e.preventDefault(),!1):!(t.href&&t.origin==location.origin&&["http:","https:"].indexOf(t.protocol)>-1&&["jpg","jpeg","png","gif","pdf","xml","json"].indexOf(t.href.toLowerCase().split(".").pop())<0)||"http:"==t.protocol&&"https:"==location.protocol||t.search||t.hash||"#"==t.href.slice(-1)?void 0:(e.preventDefault(),ajaxLoad(t.href,!0),!1)}).on("mouseover touchstart","a",function(e){console.log("triggered third event listener: ",e);var t=e.target;if(t.href&&t.origin==location.origin&&["http:","https:"].indexOf(t.protocol)>-1&&("http:"!=t.protocol||"https:"!=location.protocol)&&!t.search&&!t.hash&&"#"!=t.href.slice(-1))if(["jpg","jpeg","png","gif","pdf","xml","json"].indexOf(t.href.toLowerCase().split(".").pop())<0)ajaxLoad(t.href);else if(prefetched.indexOf(t.href)<0){prefetched.push(t.href);var o=document.createElement("link");o.rel="prefetch",o.href=t.href,document.head.appendChild(o)}}),window.onpopstate=function(e){e.state&&renderHTML(e.state,!0)},$("a.main-nav-link, a.article-date").each(function(e,t){ajaxLoad(t.href)})}
  <% } %>
})(jQuery);
