(function($){
  ...
  <% if (c.useprefetch){ %>
    !function(){var t,e,n=new Set,o=document.createElement("link"),a=o.relList&&o.relList.supports&&o.relList.supports("prefetch")&&window.IntersectionObserver&&"isIntersecting"in IntersectionObserverEntry.prototype,i="instantAllowQueryString"in document.body.dataset,r="instantAllowExternalLinks"in document.body.dataset,s="instantWhitelist"in document.body.dataset,c=65,d=!1,l=!1,u=!1;if("instantIntensity"in document.body.dataset){var f=document.body.dataset.instantIntensity;if("mousedown"==f.substr(0,"mousedown".length))d=!0,"mousedown-only"==f&&(l=!0);else if("viewport"==f.substr(0,"viewport".length))navigator.connection&&(navigator.connection.saveData||navigator.connection.effectiveType.indexOf("2g")>-1)||("viewport"==f?document.documentElement.clientWidth*document.documentElement.clientHeight<45e4&&(u=!0):"viewport-all"==f&&(u=!0));else{var m=parseInt(f);isNaN(m)||(c=m)}}if(a){var v={capture:!0,passive:!0};if(l||document.addEventListener("touchstart",function(t){e=performance.now();var n=t.target.closest("a");p(n)&&g(n.href)},v),d?document.addEventListener("mousedown",function(t){var e=t.target.closest("a");p(e)&&g(e.href)},v):document.addEventListener("mouseover",function(n){if(!(performance.now()-e<1100)){var o=n.target.closest("a");p(o)&&(o.addEventListener("mouseout",h,{passive:!0}),t=setTimeout(function(){g(o.href),t=void 0},c))}},v),u)(window.requestIdleCallback?function(t){requestIdleCallback(t,{timeout:1500})}:function(t){t()})(function(){var t=new IntersectionObserver(function(e){e.forEach(function(e){if(e.isIntersecting){var n=e.target;t.unobserve(n),g(n.href)}})});[].slice.call(document.querySelectorAll("a")).forEach(function(e){p(e)&&t.observe(e)})})}function h(e){e.relatedTarget&&e.target.closest("a")==e.relatedTarget.closest("a")||t&&(clearTimeout(t),t=void 0)}function p(t){if(t&&t.href&&(!s||"instant"in t.dataset)&&(r||t.origin==location.origin||"instant"in t.dataset)&&["http:","https:"].indexOf(t.protocol)>-1&&("http:"!=t.protocol||"https:"!=location.protocol)&&(i||!t.search||"instant"in t.dataset)&&!(t.hash&&t.pathname+t.search==location.pathname+location.search||"noInstant"in t.dataset))return!0}function g(t){if(!n.has(t)){var e=document.createElement("link");e.rel="prefetch",e.href=t,document.head.appendChild(e),n.add(t)}}}();
  <% } %>
})(jQuery);
